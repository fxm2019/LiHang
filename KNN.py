...
def Predict(testset, trainset, train_labels):
    ...
    for test_vec in testset:
        ...
        # 先把顺序的前k个点放入knn_list中，然后从剩下的点中计算与测试点的距离，将比当前k个点中最大的距离替换为剩余点中比该距离小的
        # 直到最终得到距离测试点距离最近的k个点
        for i in range(k):
...
if __name__ == '__main__':
    ...
    raw_data = pd.read_csv('E:/ML/LiHang_algorithm/train.csv', header=0)  # 读取csv数据
